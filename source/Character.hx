...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'vegeth':
				tex = Paths.getSparrowAtlas('Vegeth_Ass_sets','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Idle_vegeto', 24, false);
				animation.addByPrefix('singUP', 'Up_vegeto', 24, false);
				animation.addByPrefix('singRIGHT', 'Right_vegeto', 24, false);
				animation.addByPrefix('singDOWN', 'Down_vegeto', 24, false);
				animation.addByPrefix('singLEFT', 'Left_vegeto', 24, false);
