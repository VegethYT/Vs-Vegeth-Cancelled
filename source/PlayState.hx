				...
				case 'alley':
					{
						defaultCamZoom = 0.9;
						curStage = 'alley';
						var sky:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('sky', 'vegeth'));
						...
						var town:FlxSprite = new FlxSprite(-600, -100).loadGraphic(Paths.image('town', 'vegeth'));
						if(FlxG.save.data.antialiasing)
							{
								town.antialiasing = true;
							}
						town.scrollFactor.set(0.9, 0.9);
						town.active = false;
						add(town);

						var alley:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('alley', 'vegeth'));
						if(FlxG.save.data.antialiasing)
							{
